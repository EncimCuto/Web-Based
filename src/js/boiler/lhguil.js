$(document).ready(function() {
    ...
    function updateLHGuiloutineValue() {
        $.ajax({
            url: '../../data/boiler/lhguiloutine.php', // File PHP untuk mengambil data terbaru dari MySQL
            dataType: 'json',
    ...
    setInterval(updateLHGuiloutineValue, 1000); // Interval setiap 1 detik (1000 ms)
});