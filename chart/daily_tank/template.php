...
<link rel="stylesheet" href="../../src/css/daily_tank/chart.css">
...
<div class="info">
    <div class="dropdown">
        ...
        <div class="dropdown-content">
            <a href="./DT_RO.php?token=<?php echo htmlspecialchars($_SESSION['token']); ?>">RO Water</a>
            <a href="./DT_Salt.php?token=<?php echo htmlspecialchars($_SESSION['token']); ?>">Salt Water</a>
            <a href="./sauceA.php?token=<?php echo htmlspecialchars($_SESSION['token']); ?>">Soy Sauce A</a>
            <a href="./sauceB.php?token=<?php echo htmlspecialchars($_SESSION['token']); ?>">Soy Sauce B</a>
            <a href="./sauceC.php?token=<?php echo htmlspecialchars($_SESSION['token']); ?>">Soy Sauce C</a>
        </div>
    </div>
    ...
    <div class="checkbox-wrapper">
        <input type="checkbox" id="data1" name="data" value="DT_RO">
        <label for="data1">RO Water</label>

        <input type="checkbox" id="data2" name="data" value="DT_Salt">
        <label for="data2">Salt Water</label>

        <input type="checkbox" id="data3" name="data" value="DT_SoySauceA">
        <label for="data3">Soy Sauce A</label>

        <input type="checkbox" id="data4" name="data" value="DT_SoySauceB">
        <label for="data4">Soy Sauce B</label>

        <input type="checkbox" id="data5" name="data" value="DT_SoySauceC">
        <label for="data5">Soy Sauce C</label>
    </div>
...
<script>
    ...
    function exportData(interval) {
        ...
        let url = `../../function/daily_tank/export_data.php?tanggal-awal=${encodeURIComponent(tanggalAwal)}&tanggal-akhir=${encodeURIComponent(tanggalAkhir)}&data=${selectedData}&token=${encodeURIComponent('<?php echo $_SESSION['token']; ?>')}`;
