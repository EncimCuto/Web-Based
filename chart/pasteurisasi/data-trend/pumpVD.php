...
<div class="container">
    <div class="header">
        <h2>Speed Pump Vaccum Deaerator</h2>
        <div class="user">
            <div class="akun">
    ...
    <?php include "template-vaccum.php" ?>
</div>
...
<script>
    ...
    function kirimRequest(phpFile) {
        ...
        const selectedData = Array.from(document.querySelectorAll('input[name="data"]:checked'))
            ...
            .then(data => { // Ganti $data dengan data
                ...
                const labels = (data.SpeedPumpVD || []).map(item => item.waktu);
    ...
    document.addEventListener('DOMContentLoaded', function() {
        const data7Checkbox = document.getElementById('data7');
        if (data7Checkbox) {
            data7Checkbox.checked = true;
        }
    });
