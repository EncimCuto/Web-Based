...
<div class="container">
    ...
    <?php include "template-mixing.php" ?>
</div>
...
<script>
    ...
    function kirimRequest(phpFile) {
        ...
        const selectedData = Array.from(document.querySelectorAll('input[name="data"]:checked'))
            ...
            .then(data => { // Ganti $data dengan data
                ...
                const labels = (data.SpeedPompaMixing || []).map(item => item.waktu);
    ...
    document.addEventListener('DOMContentLoaded', function() {
        const data1Checkbox = document.getElementById('data1');
        if (data1Checkbox) {
            data1Checkbox.checked = true;
        }
    });
