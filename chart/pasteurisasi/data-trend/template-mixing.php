...
<div class="info">
    <div class="dropdown">
        ...
        <div class="dropdown-content">
            <a href="./pompamixing.php?token=<?php echo htmlspecialchars($_SESSION['token']); ?>">Speed Pompa Mixing</a>
            <a href="./pressure-mixing.php?token=<?php echo htmlspecialchars($_SESSION['token']); ?>">Pressure Mixing</a>
            <a href="./mixingAM.php?token=<?php echo htmlspecialchars($_SESSION['token']); ?>">MixingAM</a>
        </div>
    </div>
