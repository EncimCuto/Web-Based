...
<head>
    ...
    <title>Realtime Suhu Preheating</title>
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (data.length > 0) {
                        ...
                        let oneHourAgo = new Date(newestDataTime.getTime() - 1 * 60 * 60 * 1000); // 1 jam yang lalu
                        ...
                        data.forEach(row => {
                            ...
                            // Filter hanya data dari 1 jam terakhir
                            if (rowTime >= oneHourAgo) {
                                labels.push(row.waktu);
                                dataPoints.push(row.SuhuPreheating);
                            }
                        });

                        labels.reverse(); // Menampilkan data dari yang terbaru ke yang paling lama
                        dataPoints.reverse();
