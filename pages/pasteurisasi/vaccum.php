...
<head>
    ...
    <link rel="stylesheet" href="../../src/css/pasteurisasi/style.css">
    ...
    <script src="../../src/js/pasteurisasi/lvlBT1.js"></script>
    <script src="../../src/js/pasteurisasi/pump1.js"></script>
    <script src="../../src/js/pasteurisasi/VD.js"></script>
    <script src="../../src/js/pasteurisasi/pumpVD.js"></script>
    <script src="../../src/js/pasteurisasi/BT1AM.js"></script>
    <script src="../../src/js/pasteurisasi/VDAM.js"></script>
    <script src="../../src/js/pasteurisasi/VDHH.js"></script>
    <script src="../../src/js/pasteurisasi/VDLL.js"></script>
    <script src="../../src/js/pasteurisasi/press-to-pasteur.js"></script>
</head>
...
<body>
    ...
    <div class="container">
        ...
        <div class="data">
            <div class="info">
                <img src="../../src/img/pasteurisasi/vaccum.png" alt="">
            </div>
            <div class="date">
            ...
            <p id="BT1AM" class="BT1AM"></p>
            <p id="VDAM" class="VDAM"></p>
            <p id="VDHH" class="VDHH"></p>
            <p id="VDLL" class="VDLL"></p>
            <p id="press-pasteur" class="press-pasteur"></p>
        </div>
    </div>
