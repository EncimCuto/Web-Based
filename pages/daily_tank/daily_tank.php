...
if ($mesin !== 'daily_tank' && $bagian !== 'Master' && $bagian !== 'Produksi') {
...
<head>
    ...
    <link rel="stylesheet" href="../../src/css/daily_tank/style.css">
    ...
    <script src="../../src/js/daily_tank/date.js"></script>
    <script src="../../src/js/daily_tank/DT_RO.js"></script>
    <script src="../../src/js/daily_tank/DT_Salt.js"></script>
    <script src="../../src/js/daily_tank/sauceA.js"></script>
    <script src="../../src/js/daily_tank/sauceB.js"></script>
    <script src="../../src/js/daily_tank/sauceC.js"></script>
...
<body>
    ...
    <div class="container">
        ...
        <div class="data">
            <div class="data">
                <div class="info">
                    <img src="../../src/img/daily_tank/tampilan.png" alt="">
                </div>
                <div class="date">
