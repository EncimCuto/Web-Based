...
<head>
    ...
    <link rel="stylesheet" href="../../src/css/daily_tank/data-trend.css">
...
<body>
    <label>
        <div class="slide">
            ...
            <ul>
                <li><a href="./daily_tank.php?token=<?php echo htmlspecialchars($_SESSION['token']); ?>"><i class="fas fa-tv"></i>Dashboard</a></li>
        ...
        <div class="info">
            <div class="dropdown">
                ...
                <div class="dropdown-content">
                    <a href="../../chart/daily_tank/DT_RO.php?token=<?php echo htmlspecialchars($_SESSION['token']); ?>">RO Water</a>
                    <a href="../../chart/daily_tank/DT_Salt.php?token=<?php echo htmlspecialchars($_SESSION['token']); ?>">Salt Water</a>
                    <a href="../../chart/daily_tank/sauceA.php?token=<?php echo htmlspecialchars($_SESSION['token']); ?>">Soy Sauce A</a>
                    <a href="../../chart/daily_tank/sauceB.php?token=<?php echo htmlspecialchars($_SESSION['token']); ?>">Soy Sauce B</a>
                    <a href="../../chart/daily_tank/sauceC.php?token=<?php echo htmlspecialchars($_SESSION['token']); ?>">Soy Sauce C</a>
                </div>
            </div>
        </div>
    </div>
