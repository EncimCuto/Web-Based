...
<div class="slide">
    ...
    <ul>
        <li><a href="../page/admin.php?token=<?php echo htmlspecialchars($_SESSION['token']); ?>"><i class="fas fa-tv"></i>Dashboard</a></li>
        <li><a href="../admin/pengguna.php?token=<?php echo htmlspecialchars($_SESSION['token']); ?>"><i class="fa-solid fa-users"></i>Pengguna</a></li>
        <li><a href="../page/form.php?token=<?php echo htmlspecialchars($_SESSION['token']); ?>"><i class="fas fa-file"></i>Form</a></li>
...
<?php
include_once '../function/koneksi.php'; // Pastikan koneksi sudah benar
            ...
            while ($row = $result->fetch_assoc()) {
                echo "<tr>
                   ...
                   <td style='padding: 10px;'>
                       <a href='../admin/lihat_pdf.php?id=" . $row['id'] . "' target='_blank'>Lihat</a> | 
                       <a href='../admin/unduh_pdf.php?id=" . $row['id'] . "'>Unduh</a>
                   </td>
               </tr>";
                $no++;
            }
